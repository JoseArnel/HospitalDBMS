...
def submit():
    ...
    c.execute("INSERT INTO diagnoses  VALUES (:diagnosis_id, :results, :appointment_id)",
        {
...
def delete():
    ...
    # deleting 
    c.execute("DELETE FROM diagnoses  WHERE diagnosis_id =" + selector.get())
...
def edit():
    ...
    #query 
    c.execute("SELECT * FROM diagnoses  WHERE diagnosis_id=" + entity_id)
    results = c.fetchall()
