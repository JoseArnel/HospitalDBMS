...
#create textboxes 
hospital_id = Entry(root, width=30)
hospital_id.grid(row=0,column=1,padx=20,pady=(20,0)) 

hospital_name = Entry(root, width=30)
hospital_name.grid(row=1,column=1,padx=20) 
...
postal_code.grid(row=5,column=1,padx=20) 

#create text box labels 
hospital_id_label = Label(root, text="Hospital ID")
hospital_id_label.grid(row=0, column=0,pady=(20,0))

hospital_name_label = Label(root, text="Hospital Name")
hospital_name_label.grid(row=1, column=0)
...
postal_code_label.grid(row=5,column=0)
